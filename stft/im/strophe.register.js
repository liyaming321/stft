...
*/
        ...
        if (conn.disco) conn.disco.addFeature(Strophe.NS.REGISTER);
        ...
        var connect_cb = conn._connect_cb.bind(conn); conn._connect_cb = function(req, callback, raw) {
        ...
        var auth_old = conn.authenticate.bind(conn); conn.authenticate = function(matched) {
